...
export class ProductDetailComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.tabletName=this.route.snapshot.params.tabletName
    this.productDetailService.getTabDetail(this.tabletName).subscribe(data => this.productDetail=data,error=>{}
    );
